...
/**
 * Service definition for MyBusiness (v1).
 * <p>
...
{
    /**
     * @param Google_Service_MyBusiness $service
     * @param $serviceName
     * @param $resourceName
     * @param $resource
     */
    public function __construct($service, $serviceName, $resourceName, $resource)
    {
        ...
        $service->servicePath = '';
        $service->version = 'v1';
        $service->serviceName = 'mybusinessbusinessinformation';
...
class Google_Service_MyBusiness_AccountsLocationsReviews_Resource extends \Google_Service_Resource
{
    ...
    public function __construct($service, $serviceName, $resourceName, $resource)
    {
        $service->rootUrl = 'https://mybusiness.googleapis.com/';
        $service->servicePath = '';
        $service->version = 'v4';
        $service->serviceName = 'mybusiness';
...
class Google_Service_MyBusiness_Location extends \Google_Collection
{
    ...
    public function setStorefrontAddress(Google_Service_MyBusiness_PostalAddress $storefrontAddress)
    {
